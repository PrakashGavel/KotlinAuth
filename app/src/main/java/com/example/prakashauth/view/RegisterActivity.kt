...
import com.example.prakashauth.databinding.ActivityRegisterBinding
...
import com.example.prakashauth.view_model.RegisterActivityModelFactory
import com.example.prakashauth.view_model.RegisterActivityViewModel
...
//        }
        ...
        mViewModel.getUser().observe(this) {
            if (it != null) {
                startActivity(Intent(this, HomeActivityRegister::class.java))
            }
        }
    }
