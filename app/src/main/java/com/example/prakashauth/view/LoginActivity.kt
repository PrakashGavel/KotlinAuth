package com.example.prakashauth.view
...
import com.example.prakashauth.R
import com.example.prakashauth.data.LoginBody
import com.example.prakashauth.databinding.ActivityLoginBinding
import com.example.prakashauth.repository.AuthRepository
import com.example.prakashauth.utils.APIService
import com.example.prakashauth.utils.VibrateView
import com.example.prakashauth.view_model.LoginActivityViewModel
import com.example.prakashauth.view_model.LoginActivityViewModelFactory
...
class LoginActivity : AppCompatActivity(), View.OnClickListener, View.OnFocusChangeListener,
    ...
    private fun setupObservers() {
        ...
        mViewModel.getUser().observe(this) {
            if (it != null) {
                // Update this line to navigate to HomeActivityLogin instead of HomeActivityRegister
                startActivity(Intent(this, HomeActivityLogin::class.java))
                finish()  // Optionally finish the LoginActivity so the user can't navigate back to it
            }
        }
    }
